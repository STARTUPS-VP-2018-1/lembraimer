...
public class TelaMobile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botaoAcessar.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
    ...
    private void botaoAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAcessarActionPerformed
        ...
        login.setSenha(this.jPasswordField1.getText());
        
        UsuarioInterface usuario = new UsuarioBusiness();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaMobile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaMobile().setVisible(true);
            }
        });
    }
